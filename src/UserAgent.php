...
class UserAgent
{
    ...
    {
        if (isset($_SERVER['HTTP_acceptLangUAGE']) && $_SERVER['HTTP_acceptLangUAGE'] != '') {
            $l = preg_replace('/(;q=[0-9\.]+)/i', '', strtolower(trim($_SERVER['HTTP_acceptLangUAGE'])));
    ...
    {
        if (isset($_SERVER['HTTP_acceptCharset']) && $_SERVER['HTTP_acceptCharset'] != '') {
            $c = preg_replace('/(;q=.+)/i', '', strtolower(trim($_SERVER['HTTP_acceptCharset'])));
     ...
     * @return bool
     */
    public function acceptLang($language = 'en')
    {
        return in_array(strtolower($language), $this->language(), true);
    }
    ...
    {
        return in_array(strtolower($charset), $this->charset(), true);
    }
